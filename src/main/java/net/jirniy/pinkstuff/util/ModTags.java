...
public class ModTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> CORRERIE_LOGS = createTag("correrie_logs");
    ...
    public static class Items {
        ...
        public static final TagKey<Item> CORRERIE_LOGS = createTag("correrie_logs");
        ...
        public static final TagKey<Item> CORRUPT_MASS_CONVERTIBLE = createTag("corrupt_mass_convertible");
    ...
    public static class Biomes {
        public static final TagKey<Biome> IS_STYXIA = createTag("is_styxia");
        public static final TagKey<Biome> NON_WATER = createTag("non_water");

        private static TagKey<Biome> createTag(String name) {
            return TagKey.of(RegistryKeys.BIOME, Identifier.of(JirniysPinkStuff.MOD_ID, name));
        }
    }
