...
public class ModArmorMaterials {
    ...
    public static final ArmorMaterial KUNZITE_ARMOR_MATERIAL = new ArmorMaterial(500, Util.make(new EnumMap<>(EquipmentType.class), map -> {
    ...
    public static final ArmorMaterial ELYSIUM_ARMOR_MATERIAL = new ArmorMaterial(500, Util.make(new EnumMap<>(EquipmentType.class), map -> {
