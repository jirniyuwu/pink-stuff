...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        valueLookupBuilder(ItemTags.FLOWERS)
                ...
                .add(ModBlocks.BROWN_EVERBUD.asItem())
        ...
        valueLookupBuilder(ItemTags.SAPLINGS)
                ...
                .add(ModBlocks.KEAPHE_SAPLING.asItem())
        ...
        valueLookupBuilder(ItemTags.SLABS)
                ...
                .add(ModBlocks.CLOUDSTONE_BRICKS_SLAB.asItem())
                .add(ModBlocks.AMETANE_BRICKS_SLAB.asItem())
                .add(ModBlocks.RAINBOW_STONE_BRICKS_SLAB.asItem())
                ...
                .add(ModBlocks.POLISHED_CLOUDSTONE_SLAB.asItem())
                .add(ModBlocks.POLISHED_AMETANE_SLAB.asItem())
                .add(ModBlocks.POLISHED_RAINBOW_STONE_SLAB.asItem())
        ...
        valueLookupBuilder(ItemTags.STAIRS)
                ...
                .add(ModBlocks.CLOUDSTONE_BRICKS_STAIRS.asItem())
                .add(ModBlocks.AMETANE_BRICKS_STAIRS.asItem())
                .add(ModBlocks.RAINBOW_STONE_BRICKS_STAIRS.asItem())
                ...
                .add(ModBlocks.POLISHED_CLOUDSTONE_STAIRS.asItem())
                .add(ModBlocks.POLISHED_AMETANE_STAIRS.asItem())
                .add(ModBlocks.POLISHED_RAINBOW_STONE_STAIRS.asItem())
        ...
        valueLookupBuilder(ItemTags.WALLS)
                ...
                .add(ModBlocks.CLOUDSTONE_BRICKS_WALL.asItem())
                .add(ModBlocks.AMETANE_BRICKS_WALL.asItem())
                .add(ModBlocks.RAINBOW_STONE_BRICKS_WALL.asItem())
                ...
                .add(ModBlocks.POLISHED_CLOUDSTONE_WALL.asItem())
                .add(ModBlocks.POLISHED_AMETANE_WALL.asItem())
                .add(ModBlocks.POLISHED_RAINBOW_STONE_WALL.asItem())
        ...
        valueLookupBuilder(ModTags.Items.KEAPHE_LOGS)
                ...
                .add(ModBlocks.STRIPPED_KEAPHE_LOG.asItem())
                .add(ModBlocks.STRIPPED_KEAPHE_WOOD.asItem());
        valueLookupBuilder(ModTags.Items.WASTEWOOD_LOGS)
                .add(ModBlocks.WASTEWOOD_LOG.asItem())
                .add(ModBlocks.WASTEWOOD_WOOD.asItem())
                .add(ModBlocks.STRIPPED_WASTEWOOD_LOG.asItem())
                .add(ModBlocks.STRIPPED_WASTEWOOD_WOOD.asItem());
        ...
        valueLookupBuilder(ItemTags.WOODEN_SHELVES)
                ...
                .add(ModBlocks.MAPLE_SHELF.asItem())
